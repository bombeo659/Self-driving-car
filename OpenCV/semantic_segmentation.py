...
ap.add_argument("-m", "--model", required=True, help="models.net")
ap.add_argument("-c", "--classes", required=True, help="models.txt")
ap.add_argument("-i", "--image", required=True, help="img.png")
ap.add_argument("-l", "--colors", type=str, help="colors.txt")
ap.add_argument("-w", "--width", type=int, default=500, help="245")
