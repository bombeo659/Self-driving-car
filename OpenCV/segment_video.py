...
ap.add_argument("-m", "--model", required=True, help="~/PycharmProjects/OpenCVforself-drivingcar/models.net")
ap.add_argument("-c", "--classes", required=True, help="~/PycharmProjects/OpenCVforself-drivingcar/models.txt")
ap.add_argument("-v", "--video", required=True, help="~/PycharmProjects/OpenCVforself-drivingcar/video_test.mp4")
ap.add_argument("-o", "--output", required=True, help="~/PycharmProjects/OpenCVforself-drivingcar")
ap.add_argument("-s", "--show", type=int, default=1, help="whether or not to display frame to screen")
ap.add_argument("-l", "--colors", type=str, help="~/PycharmProjects/OpenCVforself-drivingcar/colors.txt")
